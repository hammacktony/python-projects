...
class Bookstore(object):
    ...
    def update_command(self):
        self.database.update(self.selected_tuple[0],self.title_text.get(),self.author_text.get(),self.year_text.get(),self.isbn_text.get())

if __name__ == '__main__':
    database=Database("books.db") #Define Database
    gui=Tk() # Program Object
    Bookstore(gui,database) # Starts program
    gui.mainloop() # Keeps program running